...
export const skillsCardData: SkillsCardDataType[] = [
  ...
  { skillsImage: "/skills-icon/react-icon.svg", skillsName: "React" },
  { skillsImage: "/skills-icon/next-js-icon.svg", skillsName: "Next.js" },
  { skillsImage: "/skills-icon/typescript-icon.svg", skillsName: "TypeScript" },
];
