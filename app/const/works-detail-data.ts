...
export const CanBookDetailData: WorksDetailProps = {
  ...
  workDetail: [
    ...
    "URL　　： https://canbook.vercel.app (無料のデータベースを利用しているため期限が切れて画面が表示されない可能性がございます)",
  ],
...
export const PortfolioDetailData: WorksDetailProps = {
  ...
  workDetail: [
    ...
    "制作期間 ： 1ヶ月",
    "開発担当 ： 企画, デザイン, 開発",
    "URL　　： https://momo-41-portfolio-site.vercel.app (このサイトです)",
  ],
